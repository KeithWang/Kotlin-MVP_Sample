package demo.vicwang.myapplication.fragment
...
import demo.vicwang.myapplication.activity.MainView
            ...
            Glide.with(activity)
                    ...
                    .listener(object : RequestListener<String, GlideDrawable> {
                        override fun onException(e: Exception, model: String, target: Target<GlideDrawable>, isFirstResource: Boolean): Boolean {
                            if (activity != null)
                                wImg_Header_Img.background = getActivity()!!.getDrawable(android.R.drawable.ic_notification_clear_all)
                            return false
                        }
